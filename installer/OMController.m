...
- (NSString *)helpText
{
	...
	@"WHAT THIS APP DOES\n"
	 ...
	 "\n"
	 "Choose... is for a mod you already have on disk. Point it at the mod's folder,\n"
	 "or at a folder holding several. The content may come from any platform's\n"
	 "release, a Windows one included: maps, models, sounds and liblist.gam are the\n"
	 "same everywhere, and this app supplies the Mac game code.\n"
	 "\n"
...
- (void)showAbout:(id)sender
{
	if( aboutWindow == nil )
	{
		...
		gordon = [[[NSButton alloc] initWithFrame:NSMakeRect( 24, 30, 147, 240 )] autorelease];
		...
		if( art != nil )
		{
			[art setSize:NSMakeSize( 147, 240 )];
			[gordon setImage:art];
		}
