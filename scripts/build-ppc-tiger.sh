...
SDK="${OLDMAC_PPC_SDK:-/Developer/SDKs/MacOSX10.3.9.sdk}"   # #6: build min-10.3 so a G4 booted on Panther can load this slice (was 10.4u/min-10.4)
...
# unchanged. Issue #22.
export CC="${OLDMAC_PPC_CC:-gcc-4.0}" CXX="${OLDMAC_PPC_CXX:-g++-4.0}"   # 10.3.9 SDK's /usr/include stubs #include_next gcc-4.0's builtins (same pairing as panther)
