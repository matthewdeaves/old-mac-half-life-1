...
# World-space spherical falloff with a plane-correct texture inverse.
# Flashlight size is chosen once from the hit face. User-tested on arm64, Intel, G4 and G5.
...
PIN_MENU_COMMIT="9c7d83825421cd046ca35ddc52ac26ed788ab350"
